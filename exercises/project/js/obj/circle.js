var Circle = function(_center, _normal, _isGuide) {
	...
	this.generateVertices = function() {
		...
		triangles.push([this.skeleton[0].circle[0], this.skeleton[this.skeleton.length - 1].circle[0], this.skeleton[this.skeleton.length - 1].circle[this.skeleton[this.skeleton.length - 1].circle.length - 1]]);

		for (let j = 1; j < this.skeleton[0].circle.length; j++) {
			triangles.push([this.skeleton[0].circle[j - 1], this.skeleton[0].circle[j], this.skeleton[this.skeleton.length - 1].circle[j - 1]]);
			triangles.push([this.skeleton[0].circle[j], this.skeleton[this.skeleton.length - 1].circle[j], this.skeleton[this.skeleton.length - 1].circle[j - 1]]);
		}

		for (let i = 1; i < this.skeleton.length; i++) {
			triangles.push([this.skeleton[i].circle[this.skeleton[i].circle.length - 1], this.skeleton[i].circle[0], this.skeleton[i - 1].circle[this.skeleton[i - 1].circle.length - 1]]);
			triangles.push([this.skeleton[i].circle[0], this.skeleton[i - 1].circle[0], this.skeleton[i - 1].circle[this.skeleton[i - 1].circle.length - 1]]);

			for (let j = 1; j < this.skeleton[i].circle.length; j++) {
				triangles.push([this.skeleton[i].circle[j - 1], this.skeleton[i].circle[j], this.skeleton[i - 1].circle[j - 1]]);
				triangles.push([this.skeleton[i].circle[j], this.skeleton[i - 1].circle[j], this.skeleton[i - 1].circle[j - 1]]);
			}
		}
