...
function main() {
	...
	// Specular lightning toggler
	document.getElementById('bSpecular').addEventListener('click', function(e) {
		e.preventDefault();
		light.specular ? light.specular = false : light.specular = true;
	...
	document.getElementById('bSmooth').addEventListener('click', function(e) {
		e.preventDefault();
		light.smooth ? light.smooth = false : light.smooth = true;
	...
	document.getElementById("ns").addEventListener('input', function(e) {
		e.preventDefault();
		surface_material.Ns = this.value;
		document.getElementById("ns-val").innerHTML = surface_material.Ns;
	});
